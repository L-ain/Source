...
t0 = cputime;
train_temp = train_dat(:,2:kk);%;train_dat_fft(:,2:5)];%,train_dat_fft(:,2:6)];
test_temp = test_dat(:,2:kk);

[bestacc,bestc,bestg] = SVMcgForClass(train_label,train_temp,-10,10,-10,10,10,0.8,0.8,1);
%% 利用最佳的参数进行SVM网络训练
...
%yuce
[predict_label, accuracy,decision_values] = svmpredict(test_label, test_temp, model,'-b 0');
...
xlswrite('GS_SVM_result.xlsx',label_1_5);  %%pridict label
%%hxf
...
xlswrite('GS_SVM_result.xlsx',{'HXF_fusion(%)'},2,'A7');
xlswrite('GS_SVM_result.xlsx',{'MNT_fusion(%)'},2,'A8');
xlswrite('GS_SVM_result.xlsx',{'MNG_fusion(%)'},2,'A9');
xlswrite('GS_SVM_result.xlsx',{'Precision(%)'},2,'B6');
xlswrite('GS_SVM_result.xlsx',{'Recall(%)'},2,'C6');
xlswrite('GS_SVM_result.xlsx',{'Fscore(%)'},2,'D6');
xlswrite('GS_SVM_result.xlsx',hxf_precision,2,'B7');
xlswrite('GS_SVM_result.xlsx',hxf_recall,2,'C7');
xlswrite('GS_SVM_result.xlsx',hxf_Fscore,2,'D7');

xlswrite('GS_SVM_result.xlsx',mnt_precision,2,'B8');
xlswrite('GS_SVM_result.xlsx',mnt_recall,2,'C8');
xlswrite('GS_SVM_result.xlsx',mnt_Fscore,2,'D8');

xlswrite('GS_SVM_result.xlsx',mng_precision,2,'B9');
xlswrite('GS_SVM_result.xlsx',mng_recall,2,'C9');
xlswrite('GS_SVM_result.xlsx',mng_Fscore,2,'D9');

xlswrite('GS_SVM_result.xlsx',{'Accuracy(%)'},2,'A10');
xlswrite('GS_SVM_result.xlsx',b,2,'B10');
...
xlswrite('GS_SVM_result.xlsx',{'HXF_skin(%)'},2,'A2');
xlswrite('GS_SVM_result.xlsx',{'MNT_skin(%)'},2,'A3');
xlswrite('GS_SVM_result.xlsx',{'MNG_skin(%)'},2,'A4');
xlswrite('GS_SVM_result.xlsx',{'Precision(%)'},2,'B1');
xlswrite('GS_SVM_result.xlsx',{'Recall(%)'},2,'C1');
xlswrite('GS_SVM_result.xlsx',{'Fscore(%)'},2,'D1');
xlswrite('GS_SVM_result.xlsx',hxf_precision,2,'B2');
xlswrite('GS_SVM_result.xlsx',hxf_recall,2,'C2');
xlswrite('GS_SVM_result.xlsx',hxf_Fscore,2,'D2');

xlswrite('GS_SVM_result.xlsx',mnt_precision,2,'B3');
xlswrite('GS_SVM_result.xlsx',mnt_recall,2,'C3');
xlswrite('GS_SVM_result.xlsx',mnt_Fscore,2,'D3');

xlswrite('GS_SVM_result.xlsx',mng_precision,2,'B4');
xlswrite('GS_SVM_result.xlsx',mng_recall,2,'C4');
xlswrite('GS_SVM_result.xlsx',mng_Fscore,2,'D4');

tp = length(find(result ==  test_label));
b = tp/size(test_label,1)*100;

xlswrite('GS_SVM_result.xlsx',{'Accuracy(%)'},2,'A5');
xlswrite('GS_SVM_result.xlsx',b,2,'B5');

xlswrite('GS_SVM_result.xlsx',{'PCA维度'},3,'A1');
xlswrite('GS_SVM_result.xlsx',{'Accuracy(%)'},3,'B1');
xlswrite('GS_SVM_result.xlsx',acc,3,'A2');
bestkk
best_acc
